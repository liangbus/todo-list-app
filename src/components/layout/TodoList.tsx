...
export class TodoList extends Component<Props, State> {
  ...
  render() {
    ...
    const { mode, filteredListContent, curFilter, uncompletedCount, queryContent, createContent, totalTodoCount } = data
    ...
    return (
      <div className="todo-list-component">
        ...
        <Body {...{ switchMode, todoContentFilter, mode, uncompletedCount, curFilter, filteredListContent, upateTodoListStatus, totalTodoCount }}/>
        <Footer />
      </div>
    )
  }
